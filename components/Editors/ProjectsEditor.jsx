...
export default function ProjectsEditor({ data, onChange }) {
  ...
  const handleSave = () => {
    if (editIndex === newEntryIndex && newEntryIndex !== null) {
      const isStillEmpty = Object.values(tempEntry).every(
        ...
        {data.length > 0 ? (
          data.map((entry, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex items-start gap-4 p-4 bg-surface-rise border ${
                  isThisRowEditing
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-5 gap-6">
                  ...
                  <div className="md:col-span-1">
                    ...
                    {isThisRowEditing ? (
                      <input
                        type="text"
                        value={tempEntry?.firm || ''}
                        onChange={(e) =>
                          handleTempEntryChange('firm', e.target.value)
                        }
                        className="mt-1 w-full p-1 bg-surface-rise border-b border-border focus:border-interactive-active focus:outline-none"
                        placeholder="z.B. Tech Innovations"
                      />
                    ) : (
                  ...
                  <div className="md:col-span-3 space-y-4">
                        ...
                        <div className="flex flex-col gap-2 mt-1">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleTempEntryChange('name', e.target.value)
                              }
                              className="mt-1 w-full p-1 bg-surface-rise border-b border-border focus:border-interactive-active focus:outline-none"
                              placeholder="User-Centric Design"
                            />
                          </div>
                          <div>
                            <Label>Rolle</Label>
                            <input
                              ...
                              onChange={(e) =>
                                handleTempEntryChange('role', e.target.value)
                              }
                              className="mt-1 w-full p-1 bg-surface-rise border-b border-border focus:border-interactive-active focus:outline-none"
                              placeholder="z.B. UX Designer"
                            />
                          </div>
                        </div>
                      ) : (
                      ...
                      {isThisRowEditing ? (
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              handleTextareaChange(e, 'description')
                            }
                    ...
                    <div>
                      {isThisRowEditing ? (
                        <div>
                          ...
                          <input
                            type="text"
                            value={tempEntry?.team_size || ''}
                            onChange={(e) =>
                              handleTempEntryChange('team_size', e.target.value)
                            }
                            className="mt-1 w-full p-1 bg-surface-rise border-b border-border focus:border-interactive-active focus:outline-none"
                            placeholder="z.B. 8"
                          />
                    ...
                    <div>
                      <p className="font-semibold">
                        Meine Aufgaben umfassen dabei:
                      </p>
                      {isThisRowEditing ? (
                        <textarea
                          value={arrayToText(tempEntry?.tasks)}
                          onChange={(e) =>
                            handleArrayTextareaChange(e, 'tasks')
                          }
                          className="mt-1 w-full p-1 bg-surface-rise border-b border-border focus:border-interactive-active focus:outline-none resize-none overflow-hidden"
                          rows="1"
                    ...
                    <div>
                      ...
                      {isThisRowEditing ? (
                        <textarea
                          ...
                          onChange={(e) =>
                            handleArrayTextareaChange(e, 'technologies')
                          }
                          className="mt-1 w-full p-1 bg-surface-rise border-b border-border focus:border-interactive-active focus:outline-none resize-none overflow-hidden"
                          rows="1"
                          placeholder="Eine Technologie pro Zeile..."
                        />
                      ) : (
                        <div className="mt-1 space-y-1">
          ...
          <div className="text-center py-12 px-6 bg-surface-rise border border-border">
            ...
            <p className="mt-2 text-sm text-secondary">
              Fügen Sie Ihr erstes Projekt hinzu, um zu beginnen.
            </p>
            <button
              onClick={handleAddNew}
