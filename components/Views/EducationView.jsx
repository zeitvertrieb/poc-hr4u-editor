    ...
    <div className="w-full max-w-6xl mx-auto">
      <div className="flex flex-col mb-4 gap-4">
        ...
        <div className="flex items-center gap-4">
          <NavLink href="/content?section=profile"> <FontAwesomeIcon icon={faChevronLeft} className="h-3 w-3 mr-2" />Profil</NavLink>
      ...
      <div className="flex flex-col gap-4 mt-8">
        {data && data.length > 0 ? (
          ...
          <div className="text-center py-12 px-6 bg-surface-rise border border-border">
            <h3 className="text-lg font-semibold text-primary">Keine Ausbildung vorhanden</h3>
