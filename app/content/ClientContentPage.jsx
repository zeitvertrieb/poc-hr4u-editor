    ...
    const loadData = async () => {
      try {
        ...
        if (savedData) {
          ...
          console.warn(
            'No data in localStorage. Loading test data from /test-json.json.'
          );
  ...
  const renderContent = () => {
    switch (currentSection) {
        ...
        return isEditing ? (
          <EducationEditor
            ...
            onChange={(updatedData) =>
              handleContentChange('education', updatedData)
            }
          />
        ) : (
      ...
      case 'certifications':
        return isEditing ? (
          <CertificateEditor
            ...
            onChange={(updatedData) =>
              handleContentChange('certifications', updatedData)
            }
          />
        ) : (
      ...
      case 'professional_focus':
        return isEditing ? (
          <ProfessionalFocusEditor
            data={content.professional_focus}
            onChange={(updatedData) =>
              handleContentChange('professional_focus', updatedData)
            }
          />
        ) : (
      ...
      case 'core_qualifications':
        return isEditing ? (
          <CoreQualificationsEditor
            data={content.core_qualifications}
            onChange={(data) =>
              handleContentChange('core_qualifications', data)
            }
          />
        ) : (
      ...
      case 'industry_experience':
        return isEditing ? (
          <IndustryExperienceEditor
            data={content.industry_experience}
            onChange={(data) =>
              handleContentChange('industry_experience', data)
            }
          />
        ) : (
      ...
      case 'projects':
        return isEditing ? (
          <ProjectsEditor
            ...
            onChange={(data) => handleContentChange('projects', data)}
          />
        ) : (
      ...
      case 'hobbies':
        return isEditing ? (
          <HobbiesEditor
            ...
            onChange={(data) => handleContentChange('hobbies', data)}
          />
        ) : (
